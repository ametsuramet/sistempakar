...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header" style="color:#3851D0"> Pusat Penelitian Geoteknologi LIPI <br><span >Lembaga Ilmu Pengetahuan Indonesia</span></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12 col-md-6">
                    ...
                    <p>Untuk memudahkan pencarian data peneliti, silakan gunakan fasilitas Search di pojok kanan atas.</p>
                </div>
            </div>
            <!-- /.row -->
