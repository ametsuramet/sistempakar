...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Digit 3 
            @if(Auth::user())
            <a class="btn btn-primary pull-right" href="/admin/tambahdigit3"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Digit 3 </a>
            @endif
            </h1>
        </div>
        <!-- /.col-lg-12 -->
